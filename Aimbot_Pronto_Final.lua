...
local Colors = {
    ...
    Border = Color3.fromRGB(40, 40, 40), Accent = Color3.fromRGB(255, 255, 255), -- Red
...
createSwitch(A2, "MOVIMENTO DO MOUSE (3A PESSOA)", "SUAVIZA CÂMERA E MOUSE", "UseMouse")
createSwitch(A2, "MOVIMENTO DO MOUSE (3A E PMB)", "SUAVIZA CÂMERA E MOUSE", "UseMouse")
...
createSwitch(A3, "WALLCHECK", "S� MIRAR EM VIS�VEIS", "AimWallCheck")
